...
namespace negocio
{
    public class TraineeNegocio
    {
        ...
        public int insertarNuevo(Trainee nuevo)
        {
            ...
            try
            {
                datos.setearProcedimientos("insertarNuevo");
        ...
        public bool Login(Trainee trainee)
        {
            ...
            try
            {
                datos.setearConsulta("Select id, email, pass, imagenPerfil,admin, nombre,apellido,fechaNacimiento from USERS Where email = @email and pass = @pass");
                datos.setearParametro("@email", trainee.Email);
                datos.setearParametro("@pass", trainee.Pass);
                //datos.setearParametro("@nombre", trainee.Nombre);
                //datos.setearParametro("@apellido", trainee.Apellido);
                //datos.setearParametro("@imagen", trainee.ImagenPerfil);
